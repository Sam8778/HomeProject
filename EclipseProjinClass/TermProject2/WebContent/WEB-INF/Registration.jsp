...
<body>
	<div class="container white z-depth-2">
		<ul class="tabs teal">
			...
			<li class="tab col s3"><a class="white-text">Register</a></li>
		</ul>
		<div class="col l12 s8">
			<form class="col l12 s8" action="insert" method="post">
				<div class="form-container">
					...
					<div class="row">
						<div class="input-field col l12 s8">
							<i class="material-icons prefix">vpn_key</i> <input type="number"
								class="validate" required="required" id="eid" name="id"> <label for="eid">ID</label>
						</div>
					</div>
					<div class="row">
						<div class="input-field col l12 s8">
							<i class="material-icons prefix">person</i> <input type="text"
								class="validate" required="required" id="ename" name="name"> <label
					...
					<div class="row">
						<div class="input-field col l12 s8">
							<i class="material-icons prefix">phone</i> <input type="tel"
								class="validate" required="required" id="emobile" name="mobile"> <label
					...
					<div class="row">
						<div class="input-field col l12 s8">
							<i class="material-icons prefix">email</i> <input type="email"
								class="validate" required="required" id="eemailid" name="email"> <label
					...
					<div class="row">
						<div class="input-field col l12 s8">
							<i class="material-icons prefix">lock</i> <input type="password"
								class="validate" required="required" id="epassword" name="password"> <label
					...
					<div class="row">
						...
						<div class="input-field col l3 s4">
							<label> <input type="radio" class="with-gap pink" value="emp" name="role"> 
								<span>EMP</span>
							</label>
						</div>
						<div class="input-field col l3 s4">
							<label> <input type="radio" class="with-gap" value="admin" name="role">
								<span>ADMIN</span>
							</label>
						</div>
					</div>
